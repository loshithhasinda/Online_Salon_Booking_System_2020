            ...
            <div class="bg1">
                ...
                <div class="container1">
                    ...
                    <div class="container2">
                        ...
                        <button type="button" class="button" onclick="document.location='update_account.php'">Edit Account</button>
                        <button type="button" class="button" onclick="document.location='delete_account.php'" >Delete Account</button>
                    </div>
                    ...
                    <div class="container3">
                        ...
                        <div class="container4">
                            ...
                            <input type="text" id="input" name="first_name" value="<?php echo $first_name ?>" disabled>
    
                            <label class="f1"><b>Last Name</b></label>
                            <input type="text" id="input" name="last_name" value="<?php echo $last_name ?>" disabled>

                            <label class="f1"><b>Email</b></label>
                            <input type="text" id="input" name="email" value="<?php echo $email ?>" disabled>

                            <label class="f1"><b>Mobile No</b></label>
                            <input type="text" id="input" name="mobile_no" value="<?php echo $mobile_no ?>" disabled>
