...
<?php
    ...
    if ($appoinments)
    {
        ...
        {
            $appoinment_list .= "<tr>";
            $appoinment_list .= "<td> {$appoinment['appoinment_id']} </td>";
            $appoinment_list .= "<td> {$appoinment['customer_id']} </td>";
            ...
            $appoinment_list .= "<td> <a href=\"delete_appoinments.php?appoinment_id={$appoinment['appoinment_id']}\" onclick=\"return confirm('Do you want delete this appoinment?');\"> Delete </a></td>";
            $appoinment_list .= "</tr>";
        }
    }
    else
    ...
    // Get New Appoinments
    if (isset($_POST['new_appoinments']))
    {
        $appoinment_list = '';

        $query = "SELECT * FROM appoinment ORDER BY date DESC;";
        $appoinments = mysqli_query($conn, $query);
    ...
    // Get All Appoinments
    else if (isset($_POST['all_appoinments']))
    {
        $appoinment_list = '';
...
<html>
    <head>
        ...
        <title> Manage Appoinments - SalonBooking.lk </title>
    ...
    <body>
            ...
            <div class="cover-page-bg-img-div">
                ...
                <div class="section-topnav">
                    <div class="topnav">
                        ...
                        <button onclick="document.location='<?php echo $signup_button_link; ?>'" style="margin-left: 40px; <?php echo $button_width; ?>"> <?php echo $signup_button; ?> </button>
                        <button onclick="document.location=''" style="margin-left: 40px;"> <?php echo $signin_button; ?> </button>
                    </div>
                </div>
        ...
        <div class="section01" style="height: 2000px; background-color: #f3eded;">

            <div class="section01-div" style="margin: 0 auto; max-width: 1600px; text-align: center;">

                <p style="font-size: 30px;font-weight: bold; color: #1d2434;"> Manage Appoinments </p> <br><br> 

                <form action="manage_appoinments.php" method="post">

                    <button name="all_appoinments"> All Appoinments </button>
                    <button name="new_appoinments"> New Appoinments </button>
