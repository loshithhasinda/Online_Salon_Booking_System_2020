	...
	<body>
		...
		<div class="carousel" data-flickity>
				...
				<div class="box">
					<!--img-box---------->
					<div class="slide-img">
					<img alt="3" src="https://i.ibb.co/rFM84XY/p11.jpg">
					<!--overlayer---------->
					<div class="overlay">
					<!--buy-btn------>	
					<a href="#" class="buy-btn">Add Style</a>	
				...
				<div class="box">
					<!--img-box---------->
					<div class="slide-img">
					<img alt="4" src="https://i.ibb.co/j54dt8v/p9.jpg">
					<!--overlayer---------->
					<div class="overlay">
					<!--buy-btn------>	
					<a href="#" class="buy-btn">Add Style</a>	
				...
				<div class="box">
					<!--img-box---------->
					<div class="slide-img">
					<img alt="5" src="https://i.ibb.co/mF0rmHq/p5.jpg">
					<!--overlayer---------->
					<div class="overlay">
					<!--buy-btn------>	
					<a href="#" class="buy-btn">Add Style</a>	
				...
				<div class="box">
					<!--img-box---------->
					<div class="slide-img">
					<img alt="6" src="https://i.ibb.co/7YGhSth/p3.jpg">
					<!--overlayer---------->
					<div class="overlay">
					<!--buy-btn------>	
					<a href="#" class="buy-btn">Add Style</a>	
				...
				<div class="box">
					<!--img-box---------->
					<div class="slide-img">
					<img alt="7" src="https://i.ibb.co/b3RKRsV/p1.jpg">
					<!--overlayer---------->
					<div class="overlay">
					<!--buy-btn------>	
					<a href="#" class="buy-btn">Add Style</a>	
				...
				<div class="box">
					<!--img-box---------->
					<div class="slide-img">
					<img alt="8" src="https://i.ibb.co/KbH32nK/p2.jpg">
					<!--overlayer---------->
					<div class="overlay">
					<!--buy-btn------>	
					<a href="#" class="buy-btn">Add Style</a>	
					...
					<div class="button">
						<a href="form.html" class="bttn"><b>Add Style Cover +</b></a>	
					</div>
			</div>
		</div>
	</div>
